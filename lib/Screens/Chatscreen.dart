...
class WhatsAppUserContactScreen extends StatefulWidget {
  ...
  @override
  _WhatsAppUserContactScreenState createState() => _WhatsAppUserContactScreenState();
}
...
class _WhatsAppUserContactScreenState extends State<WhatsAppUserContactScreen> {
  ...
  void _openWhatsApp() async {
    ...
    final whatsappUrl = Uri.parse("https://wa.me/$phoneNumber?text=Hola $displayName, soy tu trabajador asignado desde la app.");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(displayName != null ? 'Contactar a $displayName' : 'Contacto por WhatsApp'),
      ),
      body: Center(
